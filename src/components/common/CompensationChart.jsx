...
const categoryData = [
    ...
    {name: 'Overtime Pay', value: 3200 },
    {name: 'Allowances', value: 2000 },
    {name: '13 Month Pay', value: 2000 },
    {name: 'Paid Leave', value: 2000 },
    {name: 'Holiday Pay', value: 1000  },
]
...
const CompensationChart = () => {
  return (
    ...
    >
      <h2 className="text-lg font-medium mb-4 text-black">Compensation</h2>
      <div className="h-80">
